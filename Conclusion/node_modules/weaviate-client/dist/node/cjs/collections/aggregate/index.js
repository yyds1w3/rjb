...
class AggregateManager {
  constructor(connection, name, dbVersionSupport, consistencyLevel, tenant) {
    ...
    this.groupBy = {
            ...
            return this.grpc()
              .then((aggregate) =>
                aggregate.withHybrid(
                  Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.hybrid(query, opts)), {
                    groupBy: index_js_4.Serialize.aggregate.groupBy(group),
                    limit: group.limit,
                  })
                )
              )
      ...
      nearImage: (image, opts) =>
        __awaiter(this, void 0, void 0, function* () {
          const [b64, usesGrpc] = yield Promise.all([
            yield (0, index_js_2.toBase64FromMedia)(image),
            yield this.grpcChecker,
          ]);
          if (usesGrpc) {
            const group = typeof opts.groupBy === 'string' ? { property: opts.groupBy } : opts.groupBy;
            return this.grpc()
              .then((aggregate) =>
                aggregate.withNearImage(
                  Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.nearImage(b64, opts)), {
                    groupBy: index_js_4.Serialize.aggregate.groupBy(group),
                    limit: group.limit,
                  })
                )
            ...
            return this.grpc()
              .then((aggregate) =>
                aggregate.withNearObject(
                  Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.nearObject(id, opts)), {
                    groupBy: index_js_4.Serialize.aggregate.groupBy(group),
                    limit: group.limit,
                  })
                )
            ...
            return this.grpc()
              .then((aggregate) =>
                aggregate.withNearText(
                  Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.nearText(query, opts)), {
                    groupBy: index_js_4.Serialize.aggregate.groupBy(group),
                    limit: group.limit,
                  })
                )
            ...
            return this.grpc()
              .then((aggregate) =>
                aggregate.withNearVector(
                  Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.nearVector(vector, opts)), {
                    groupBy: index_js_4.Serialize.aggregate.groupBy(group),
                    limit: group.limit,
                  })
                )
        ...
        __awaiter(this, void 0, void 0, function* () {
          if (yield this.grpcChecker) {
            ...
            return this.grpc()
              .then((aggregate) =>
                aggregate.withFetch(
                  Object.assign(Object.assign({}, index_js_4.Serialize.aggregate.overAll(opts)), {
                    groupBy: index_js_4.Serialize.aggregate.groupBy(group),
                    limit: group.limit,
                  })
                )
  ...
  hybrid(query, opts) {
    return __awaiter(this, void 0, void 0, function* () {
      if (yield this.grpcChecker) {
        return this.grpc()
          .then((aggregate) => aggregate.withHybrid(index_js_4.Serialize.aggregate.hybrid(query, opts)))
  ...
  nearVector(vector, opts) {
    return __awaiter(this, void 0, void 0, function* () {
      if (yield this.grpcChecker) {
        return this.grpc()
          .then((aggregate) =>
            aggregate.withNearVector(index_js_4.Serialize.aggregate.nearVector(vector, opts))
          )
          .then((reply) => index_js_3.Deserialize.aggregate(reply));
      }
      if (!utils_js_1.NearVectorInputGuards.is1DArray(vector)) {
