    ...
    create: function (config) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const makeLegacyVectorizer = (configVectorizers) => {
          ...
          const moduleConfig = {};
          moduleConfig[vectorizer] = (0, utils_js_1.parseVectorizerConfig)(
            configVectorizers.vectorizer.config
          );
          const vectorIndexConfig = (0, utils_js_1.parseVectorIndex)(configVectorizers.vectorIndex);
        ...
        if (supportsNamedVectors.supports) {
          const { vectorsConfig, vectorizers: vecs } = config.vectorizers
            ? (0, utils_js_1.makeVectorsConfig)(config.vectorizers, supportsDynamicVectorIndex)
