...
Serialize.bm25SearchOperator = (searchOperator) => {
  if (searchOperator) {
    return base_search_js_1.SearchOperatorOptions.fromPartial(
...
Serialize.bm25Search = (args) => {
  return base_search_js_1.BM25.fromPartial({
    ...
    searchOperator: _a.bm25SearchOperator(args.operator),
  });
};
...
Serialize.hybridSearch = (args) => {
  ...
  return base_search_js_1.Hybrid.fromPartial({
    ...
    bm25SearchOperator: _a.bm25SearchOperator(args.bm25Operator),
    targetVectors,
    targets,
    nearText,
    nearVector,
